...
def process_cvs():
    ...
    for candidate in candidates:
        ...
        for job in jobs:
            ...
            # Check if score already exists (optional, but good for efficiency)
            ...
            if existing_score.data:
                print("    - Score already exists, skipping (or update if needed).")
                # continue # Uncomment to skip re-evaluation
...
"""
            ...
            try:
                ...
                if extracted.get("years_of_experience") is not None: update_data["years_of_experience"] = extracted["years_of_experience"]
